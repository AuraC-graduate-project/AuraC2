...
13. Custom output validators are implemented through Judge0-sandboxed execution, but there is no interactive judging, generated/adversarial testing, input generator/validator framework, reference-solution oracle, or ML verdict path.
