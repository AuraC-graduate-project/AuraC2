...
import com.server.contestControl.authServer.exception.api.AdminAccountAlreadyExistsException;
...
public class RegistrationService {
    ...
    @Transactional
    public void registerTeam(String username, String password) {
        register(username, password, Role.TEAM);
    }

    @Transactional
    public void register(String username, String password, Role role) {
        if (role == Role.ADMIN && userService.adminExists()) {
